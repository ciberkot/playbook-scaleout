...
DOCUMENTATION = """
module: a10_scaleout_cluster_service_config_template
description:
    - None
short_description: Configures A10 scaleout.cluster.service.config.template
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        device_group=dict(type='int',),
        bucket_count=dict(type='int',),
